...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'category_id' => 1,
                'created' => '2018-06-27 00:28:59',
                'modified' => '2018-06-27 00:28:59'
            ],
        ];
        parent::init();
    }
